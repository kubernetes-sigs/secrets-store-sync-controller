...
| `rotationPollInterval`                           | Polling interval to resync secrets from the provider. To disable provider polling, set it to 0s.  | `12h`                                                                                                                                                                                 |
| `controllerName`                                 | The name of the Secrets Store Sync Controller.                                                    | `secrets-store-sync-controller`                                                                                                                                                       |
...
| `image.tag`                                      | The specific image tag to use. Overrides the image tag whose default is the chart's `appVersion`. | `v0.0.4`                                                                                                                                                                              |

...
var (
	...
	rotationPollInterval    = flag.Duration("rotation-poll-interval", 12*time.Hour, "Polling interval to resync secrets from the provider. Defaults to 2min. To disable provider polling, set it to 0s.")
